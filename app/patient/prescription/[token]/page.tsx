    ...
    import { Printer, ShieldCheck, Stethoscope, Loader2 } from "lucide-react";
    ...
    const verify = async () => {
        try {
        setLoading(true);
        const data = await getPublicPrescription({ token, phoneNumber });
    ...
    if (!prescription) {
        ...
        <div className="flex min-h-screen items-center justify-center bg-slate-100 p-4">
            ...
            <div className="mb-5 flex flex-col items-center">
                <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-slate-800 text-white">
                <ShieldCheck size={22} />
                </div>
            ...
            <button
                onClick={verify}
                disabled={loading}
                className="mt-4 flex w-full items-center justify-center gap-2 rounded-lg bg-slate-800 py-3 text-sm font-medium text-white transition hover:bg-slate-900 disabled:cursor-not-allowed disabled:opacity-60"
            >
    ...
    return (
        ...
        <style>{`
            ...
            /* Next.js dev-mode indicator — only present in dev mode, never
               in a production build, but hide it defensively just in case. */
            nextjs-portal {
        ...
        >
            ...
            <div className="space-y-1">
                ...
                <span className="text-slate-800">{prescription.patientName}</span>
                </p>
                <p>
                <span className="font-semibold text-slate-600">Phone:</span>{" "}
                <span className="text-slate-800">{prescription.phone}</span>
                </p>
            </div>
            ...
            <div className="space-y-1">
                ...
                <span className="text-slate-800">{prescription.age}</span>
                </p>
                <p>
                <span className="font-semibold text-slate-600">Gender:</span>{" "}
                <span className="text-slate-800">{prescription.gender}</span>
                </p>
                <p>
            ...
            <div className="mt-8">
                ...
                {prescription.endoscopyImages.map((image, index) => (
                    <div
                    key={index}
                    ...
                    <img
                        src={image.imageUrl}
                        alt={image.imageName || `Endoscopy image ${index + 1}`}
                    ...
                    <div className="flex items-center justify-between border-t border-slate-200 bg-slate-50 px-4 py-2.5">
                        ...
                        {index + 1} / {prescription.endoscopyImages.length}
                        </span>
                    </div>
                    </div>
                ))}
            ...
            <div className="avoid-break mt-8">
                ...
                {prescription.youtubeVideos.map((video, index) => (
            ...
            <div className="avoid-break mt-8">
                ...
                <div className="flex flex-wrap gap-2">
                {prescription.complaints.map((c, index) => (
                    <span
                    key={index}
            ...
            <div className="avoid-break mt-6">
                ...
                <div className="flex flex-wrap gap-2">
                {prescription.findings.map((f, index) => (
                    <span
                    key={index}
                    className="rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-sm text-slate-700"
                    >
            ...
            <div className="avoid-break mt-6">
                ...
                <div className="flex flex-wrap gap-2">
                {prescription.otoendoscopies.map((item, index) => (
                    <span
                    key={index}
            ...
            <div className="avoid-break mt-6">
                ...
                <div className="flex flex-wrap gap-2">
                {prescription.diagnosticNasalEndoscopies.map((item, index) => (
                    <span
                    key={index}
                    className="whitespace-pre-wrap rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-sm text-slate-700"
                    >
            ...
            <div className="avoid-break mt-6">
                ...
                <div className="flex flex-wrap gap-2">
                {prescription.videoLaryngoscopies.map((item, index) => (
                    <span
                    key={index}
                    className="whitespace-pre-wrap rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-sm text-slate-700"
                    >
            ...
            <div className="avoid-break mt-6">
                ...
                <div className="flex flex-wrap gap-2">
                {prescription.diagnoses.map((d, index) => (
                    <span
                    key={index}
